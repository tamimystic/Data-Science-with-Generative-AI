...
# installed.
TCL_PREFIX='C:/Inception BD/Data-Science-with-Generative-AI/Python/day 10 Mega Project (Iron man jarvis system)/jarvis\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/Inception BD/Data-Science-with-Generative-AI/Python/day 10 Mega Project (Iron man jarvis system)/jarvis\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/Inception BD/Data-Science-with-Generative-AI/Python/day 10 Mega Project (Iron man jarvis system)/jarvis\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/Inception BD/Data-Science-with-Generative-AI/Python/day 10 Mega Project (Iron man jarvis system)/jarvis\Library\include'
...
TCL_PACKAGE_PATH='C:/Inception BD/Data-Science-with-Generative-AI/Python/day 10 Mega Project (Iron man jarvis system)/jarvis\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Inception BD/Data-Science-with-Generative-AI/Python/day 10 Mega Project (Iron man jarvis system)/jarvis\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/Inception BD/Data-Science-with-Generative-AI/Python/day 10 Mega Project (Iron man jarvis system)/jarvis\Library\lib\tclstub86.lib'
